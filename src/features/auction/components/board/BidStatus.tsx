        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="text-right flex flex-col items-end gap-1">
            ...
            <div className="flex flex-col items-end">
              <p
                className={`text-fluid-sm font-black leading-none mb-1 ${isLeadingMe ? "text-black" : "text-gray-800"}`}
              >
                {leadingTeam?.name || "?"}
              </p>
              ...
              {teamId === null ? (
                <div className="bg-black text-minion-yellow px-2 py-1 text-fluid-xs font-heading flex items-center gap-1.5 border border-minion-yellow shadow-[2px_2px_0px_rgba(0,0,0,1)]">
                  <PixelIcon
