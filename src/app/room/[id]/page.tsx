...
type SearchParams = Promise<{ role?: string; teamId?: string; token?: string }>
...
export default async function RoomPage(props: {
  ...
  const organizerToken = role === 'ORGANIZER' ? (resolvedSearchParams.token || null) : null
  ...
  return (
    <RoomClient
      ...
      roleParam={role}
      teamIdParam={teamId}
      organizerTokenParam={organizerToken}
    />
  )
}
