...
## Firebase 운영 문제와 Socket.IO 해결 기록

- [x] Firebase 단독 운영에서 반복된 실시간, 팀장 참여, 타이머 확정 문제를 정리한다.
- [x] 사용자가 제기한 의문과 실제 해결 방향을 보고서로 작성한다.
- [x] DESCRIPTION.md에 프로젝트 설명 관점의 문제 해결 섹션을 추가한다.
- [x] 관련 문서 검증과 최소 테스트를 실행한다.
